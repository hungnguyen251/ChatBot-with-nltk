...
# Menu bar
    ...
    # Options
        ...
        help_option.add_command(label="About Alice", command=self.msg)
        ...
        # send button
        self.send_button = Button(self.send_button_frame, text="Send", width=8, relief=GROOVE, bg='white',
